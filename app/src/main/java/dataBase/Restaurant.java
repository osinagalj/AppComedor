...
public class Restaurant {
    ...
    public void removeDailyFood(){
        for(Product p : availableProducts){
            if(p.getCategory().equals(ProductCategory.DAILY_MENU))
...
*/
    ...
    */
    ...
    public void loadUsers(){
        ...
        registeredUsers.add(new CommonUser(111,"111",1200f,"Lautaro", "Osinaga", LocalDate.of(1999,5,20), Condition.NONE, Category.ALUMNO,new Discount(10)));
        registeredUsers.add(new CommonUser(222,"222",700f,"Gian", "Capozzo", LocalDate.of(1999,5,20), Condition.CELIAC, Category.ALUMNO,new Discount(10)));
        registeredUsers.add(new CommonUser(333,"333",800f,"Juan", "Perez", LocalDate.of(1999,5,20), Condition.VEGETARIAN, Category.ALUMNO,new Discount(10)));
        registeredUsers.add(new CommonUser(444,"444",800f,"Leo", "Messi", LocalDate.of(1999,5,20), Condition.VEGAN, Category.ALUMNO,new Discount(10)));
    }

    private void loadProducts(){

        Food f1 = new Food(1009,"Pizza","Porcion de 200 g", R.drawable.food_porcion_pizza, ProductCategory.BUFFET,Condition.NONE,6, 20.2f, new ArrayList<>());
        Food f2 = new Food(1009,"Vaso de Coca-Cola","200 ml", R.drawable.food_vaso_coca, ProductCategory.BUFFET,Condition.NONE,6, 20.2f, new ArrayList<>());

        //Buffet
        availableProducts.add(new Food(1002,"Tarta de Pollo","Con cebolla, morron y queso", R.drawable.food_tarta_pollo, ProductCategory.BUFFET,Condition.NONE,6, 88.0f, new ArrayList<>()));
        availableProducts.add(new Food(1003,"Tarta de Calabaza", "Con queso", R.drawable.food_tarta_calabaza, ProductCategory.BUFFET,Condition.NONE, 2, 85.0f, new ArrayList<>()));
        availableProducts.add(new Food(1007,"Cafe con leche", "Con queso", R.drawable.food_cafe_con_leche, ProductCategory.BUFFET,Condition.NONE, 2, 85.0f, new ArrayList<>()));
        availableProducts.add(new Food(1008,"Pebete de JyQ","Con chips de chocolate", R.drawable.food_pebete_jyq, ProductCategory.BUFFET,Condition.NONE,6, 20.2f, new ArrayList<>()));
        availableProducts.add(new Food(1009,"Pizza","Porcion de 200 g", R.drawable.food_porcion_pizza, ProductCategory.BUFFET,Condition.NONE,6, 20.2f, new ArrayList<>()));
        availableProducts.add(new Food(1009,"Tostado","de JyQ", R.drawable.food_tostado_jyq, ProductCategory.BUFFET,Condition.NONE,6, 20.2f, new ArrayList<>()));

        availableProducts.add(new Food(1009,"Coca-Cola 500 ml","Botella de Coca-Cola", R.drawable.food_botella_coca, ProductCategory.BUFFET,Condition.NONE,6, 20.2f, new ArrayList<>()));
        availableProducts.add(new Food(1009,"Empanada","De carne, cebolla y morron", R.drawable.food_empanada, ProductCategory.BUFFET,Condition.NONE,6, 20.2f, new ArrayList<>()));
        ...
        //Kiosko
        availableProducts.add(new Food(1004,"Alfajor Pepitos","Con chips de chocolate", R.drawable.food_alfajor_pepitos, ProductCategory.KIOSKO,Condition.NONE,6, 20.2f, new ArrayList<>()));
        availableProducts.add(new Food(1006,"Galletitas 9 de oro","Agridulce", R.drawable.food_9_de_oro_agridulce, ProductCategory.KIOSKO,Condition.NONE, 6, 88.0f, new ArrayList<>()));
        availableProducts.add(new Food(1005,"Pepas trio","Rellenas de membrillo", R.drawable.food_pepas_trio, ProductCategory.KIOSKO,Condition.NONE,6, 20.2f, new ArrayList<>()));
        availableProducts.add(new Food(1009,"Frutigram de chocolate","Con chips de chocolate", R.drawable.food_frutigran_chocolate, ProductCategory.KIOSKO,Condition.NONE,6, 20.2f, new ArrayList<>()));
        availableProducts.add(new Food(1009,"Pepas 9 de Oro","Rellenas con membrillo", R.drawable.food_pepas_9_de_oro, ProductCategory.KIOSKO,Condition.NONE,6, 20.2f, new ArrayList<>()));
        availableProducts.add(new Food(1009,"Pepas chocotrio","Rellenas con membrillo recubiertas de chocolate", R.drawable.food_pepas_trio_chocotrio, ProductCategory.KIOSKO,Condition.NONE,6, 20.2f, new ArrayList<>()));
    ...
    private void loadMenus() {
        ...
        menu.add(new DailyMenu(1001,"Milanesa con papas fritas","Carne vacuna y papas McCain", R.drawable.food_milanesas_con_fritas, ProductCategory.DAILY_MENU, Condition.NONE, MAX_STOCK, 88.0f, 2));
        menu.add(new DailyMenu(1001,"Milanesa con papas fritas","Berenjena y papas McCain", R.drawable.food_milanesas_con_fritas, ProductCategory.DAILY_MENU, Condition.VEGETARIAN, MAX_STOCK, 88.0f, 2));
        menu.add(new DailyMenu(1001,"Carne con papas fritas","Carne vacuna y papas McCain", R.drawable.food_carne_papas, ProductCategory.DAILY_MENU, Condition.CELIAC, MAX_STOCK, 88.0f, 2));
        menu.add(new DailyMenu(1001,"Milanesa con papas fritas","Berenjena y papas McCain", R.drawable.food_milanesas_con_fritas, ProductCategory.DAILY_MENU, Condition.VEGETARIAN, MAX_STOCK, 88.0f, 2));
