...
public class AdapterPendientes extends RecyclerView.Adapter<com.example.navigationdrawerpractica.MyOrders.Fragment.Pendientes.AdapterPendientes.ViewHolder> implements View.OnClickListener {
    ...
    @NonNull
    @Override
    public com.example.navigationdrawerpractica.MyOrders.Fragment.Pendientes.AdapterPendientes.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new com.example.navigationdrawerpractica.MyOrders.Fragment.Pendientes.AdapterPendientes.ViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull com.example.navigationdrawerpractica.MyOrders.Fragment.Pendientes.AdapterPendientes.ViewHolder holder, int position) {
